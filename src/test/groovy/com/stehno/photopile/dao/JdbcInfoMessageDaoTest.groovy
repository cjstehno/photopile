...
class JdbcInfoMessageDaoTest extends DbEnvironmentTester {
    ...
    JdbcInfoMessageDaoTest(){
        tables = ['info_messages']
    }

    @Before
    void before(){
        infoMessageDao = new JdbcInfoMessageDao( jdbcTemplate: jdbcTemplate )
    }
