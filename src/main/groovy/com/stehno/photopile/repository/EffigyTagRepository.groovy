...
/**
 * Created by cjstehno on 1/10/15.
 */
@Repository(Tag)
abstract class EffigyTagRepository implements TagRepository {

    @Create
    abstract Long create(String category, String name)

    @Update
    abstract boolean update(Tag tag)

    @Retrieve
    abstract Tag retrieve(Long id)
